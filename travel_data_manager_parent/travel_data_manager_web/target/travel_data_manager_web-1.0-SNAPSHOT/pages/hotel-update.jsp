...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/hotel/update"
              method="post">
            <%--隐藏域 用于提交id--%>
            <input type="hidden" value="${requestScope.hotel.hotelId}" name="id"/>
            <!-- 正文区域 -->
            <section class="content"> <!--酒店信息-->
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="hotelId"
                                   placeholder="编号" value="${requestScope.hotel.hotelId}" readonly>
                        </div>
                        <div class="col-md-2 title">酒店名称</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="hotelName"
                                   placeholder="酒店名称" value="${requestScope.hotel.hotelName}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="phoneNum"
                                   placeholder="联系电话" value="${requestScope.hotel.phoneNum}">
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" placeholder="酒店价格"
