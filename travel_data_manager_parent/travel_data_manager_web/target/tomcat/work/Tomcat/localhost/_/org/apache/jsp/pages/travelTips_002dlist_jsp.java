 ...
 * Generated at: 2023-06-10 08:16:07 UTC
...
public final class travelTips_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <h1>\r\n");
      out.write("                游记管理 <small>全部游记</small>\r\n");
      out.write("            </h1>\r\n");
      ...
      out.write("                        href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/travelTips/findAll\">游记管理</a></li>\r\n");
      out.write("\r\n");
      out.write("                <li class=\"active\">全部游记</li>\r\n");
      out.write("            </ol>\r\n");
      out.write("        </section>\r\n");
      out.write("        <!-- 内容头部 /-->\r\n");
      out.write("\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/pages/traveltip-add.jsp'\">\r\n");
      out.write("                                        <i class=\"fa fa-file-o\"></i> 新建\r\n");
      out.write("                                    </button>\r\n");
      out.write("\r\n");
      out.write("                                    <button type=\"button\" class=\"btn btn-default\" title=\"删除\" id=\"del\">\r\n");
      out.write("                                        <i class=\"fa fa-file-o\"></i> 删除\r\n");
      out.write("                                    </button>\r\n");
      out.write("\r\n");
      ...
      out.write("                        </div>\r\n");
      out.write("                        <!--工具栏/-->\r\n");
      out.write("                        <form action=\"/travelTips/deleteByIds\" method=\"post\" id=\"delForm\">\r\n");
      out.write("\r\n");
      out.write("                            <!--数据列表-->\r\n");
      ...
      out.write("                                    <th class=\"sorting_desc\">分享时间</th>\r\n");
      out.write("                                    <th class=\"sorting_asc sorting_asc_disabled\">目标地点</th>\r\n");
      out.write("                                    <th class=\"sorting_desc sorting_desc_disabled\">作者</th>\r\n");
      out.write("                                    <th class=\"sorting\">简介</th>\r\n");
      out.write("                                    <th class=\"sorting\">阅读次数</th>\r\n");
      ...
      out.write("                                <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/travelTips/findAll?page=1&pageSize=");
      ...
      out.write("                                <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/travelTips/findAll?page=");
      ...
      out.write("        //获取下拉框的值\r\n");
      out.write("        var pageSize = $(\"#changePageSize\").val();//获取选中的数据\r\n");
      out.write("\r\n");
      out.write("        //向服务器发送请求，改变没页显示条数\r\n");
      out.write("        location.href = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/travelTips/findAll.do?page=1&pageSize=\"\r\n");
      out.write("            + pageSize;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("        //alert(\"haha\");\r\n");
      out.write("        //1.获取所有的复选框 判断复选框的状态是否为选中\r\n");
      out.write("        var chs = document.getElementsByName(\"ids\");\r\n");
      out.write("        var flag = false;//标记\r\n");
      out.write("        for (var i = 0; i < chs.length; i++) {\r\n");
      out.write("            if (chs[i].checked) {\r\n");
      out.write("                flag = true;\r\n");
      out.write("            }\r\n");
      out.write("            ;//chs[i].checked 如果为true  表示属于选中  如果是false  则表示未选中\r\n");
      out.write("        }\r\n");
      out.write("        //2.判断是否存在选择的复选框\r\n");
      out.write("        if (flag) {//点击了删除按钮 存在需要被删除的数据\r\n");
      out.write("            //提交  还需要防止误操作\r\n");
      out.write("            if (confirm(\"亲,您确定删除吗？\")) {\r\n");
      out.write("                //alert(\"好把\");\r\n");
      out.write("                //就是提交选中的复选框就行\r\n");
      out.write("                document.getElementById(\"delForm\").submit();\r\n");
      out.write("            } else {\r\n");
      out.write("                alert(\"您在逗哥!!!\");\r\n");
      out.write("            }\r\n");
      out.write("        } else {//点击了删除按钮 但是没有需要删除的数据\r\n");
      out.write("            alert(\"手别抖!!!\")\r\n");
      out.write("        }\r\n");
      out.write("    })\r\n");
      out.write("</script>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/travelTips-list.jsp(153,32) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/pages/travelTips-list.jsp(153,32) '${pageInfo.list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${pageInfo.list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /pages/travelTips-list.jsp(153,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("travelTip");
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.tipId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\"></td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.tipId }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.shareTime }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.address }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.author }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.introduction }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.readCount }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("</td>\r\n");
          out.write("                                        <td class=\"text-center\">\r\n");
          out.write("                                            <a onclick=\"location.href='");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("/travelTips/updateCountById?tipId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.tipId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("'\" class=\"btn bg-olive btn-xs\">详情查看</a>\r\n");
          out.write("                                            <a onclick=\"location.href='");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("/travelTips/findById?tipId=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${travelTip.tipId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /pages/travelTips-list.jsp(233,28) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setBegin(1);
    // /pages/travelTips-list.jsp(233,28) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    // /pages/travelTips-list.jsp(233,28) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f1.setVarStatus("1");
    // /pages/travelTips-list.jsp(233,28) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
